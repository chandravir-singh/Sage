...
import com.google.ai.sample.SpeechToTextWrapper
...
internal fun ChatRoute(
    ...
    Surface(
        ...
        color = Color(0x2200244A) // Set background color to white
    ){
    Scaffold(
...
fun ChatList(
    ...
    if(chatMessages.lastOrNull()?.participant == Participant.SAGE){
        var cm=chatMessages.lastOrNull()
        if (cm != null) {
            TextToSpeechWrapper(speakText = cm.text, speakEnable=true )
        }
    }
}
...
fun ChatBubbleItem(
    ...
    val isModelMessage = chatMessage.participant == Participant.SAGE ||
            chatMessage.participant == Participant.ERROR


    val backgroundColor = when (chatMessage.participant) {
        Participant.SAGE -> Color(0xFF00244A)
        Participant.USER -> Color(0xFFA2BEFF)
